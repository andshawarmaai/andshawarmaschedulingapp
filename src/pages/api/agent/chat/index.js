...
async function callHermes(tunnelUrl, payload) {
  ...
  // 58s — matches REQUEST_TIMEOUT_MS in scripts/hermes-bridge.mjs and
  // sits safely under Vercel's hobby 60s maxDuration cap. The previous
  // 56s used to give up before the bridge itself did, leaving a
  // confusing "aborted" instead of a clean timeout error from upstream.
